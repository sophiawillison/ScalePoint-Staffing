        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <nav aria-label="Explore" className="text-[15px]">
            ...
            <ul className="space-y-2.5 text-mineral/75">
              ...
              <li><Link href="/executive-profile" className="hover:text-mineral">Submit Executive Profile</Link></li>
              <li><Link href="/employer-search" className="hover:text-mineral">Submit Hiring Requirement</Link></li>

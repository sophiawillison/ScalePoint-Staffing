    ...
    >
      <div className="shell flex h-[68px] items-center justify-between gap-4">
        ...
        <Link href="/" className="flex flex-col leading-none" aria-label={`${config.brandName}, home`}>
          <span className={cn('text-[19px] font-extrabold tracking-tight', overDark ? 'text-mineral [text-shadow:0_1px_3px_rgba(0,0,0,0.45)]' : 'text-ink')}>
            {config.brandShort}
          </span>
          <span className={cn('mt-0.5 text-[9px] font-semibold uppercase tracking-[0.32em]', overDark ? 'text-mineral/80' : 'text-slate')}>
            Staffing
          </span>
        </Link>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  overDark
                    ? cn('[text-shadow:0_1px_3px_rgba(0,0,0,0.45)]', active ? 'text-mineral' : 'text-mineral/90 hover:text-mineral')

...
export function ExecutiveHome() {
  return (
    <>
      {/* 1, Hero with live video banner */}
      <section className="relative overflow-hidden bg-carbon on-dark">
        <HeroVideo
          sources={HERO_MEDIA.executive.sources}
          poster={HERO_MEDIA.executive.poster}
          overlay="from-carbon/80 via-carbon/70 to-carbon"
        ...
        <div className="shell relative flex min-h-[92vh] flex-col justify-center pb-24 pt-36">
          <Reveal>
            <p className="eyebrow eyebrow--light">Executive Opportunities · United States</p>
          </Reveal>
          <Reveal delay={80}>
          ...
          <Reveal delay={160}>
            <p className="mt-6 max-w-xl text-[19px] leading-relaxed text-mineral/90">
              Discover confidential senior-level opportunities matched around your experience, leadership scope
              and ambition, not application volume.
            </p>
          </Reveal>
          <Reveal delay={240}>
          ...
          <Reveal delay={300}>
            <p className="mt-8 text-[13.5px] text-mineral/75">Confidential by default. No public profile required.</p>
          </Reveal>
        </div>
      </section>

...
export function EmployerHome() {
  return (
    <>
      {/* 1 — Hero (immersive, distinct plum accent) */}
      <section className="relative overflow-hidden bg-carbon on-dark">
        <div aria-hidden className="pointer-events-none absolute inset-0"
          style={{ background: 'radial-gradient(70% 60% at 22% 8%, rgba(168,68,106,0.22), transparent 62%)' }} />
        <div aria-hidden className="pointer-events-none absolute inset-0"
          style={{ background: 'radial-gradient(50% 40% at 90% 100%, rgba(123,45,70,0.18), transparent 70%)' }} />

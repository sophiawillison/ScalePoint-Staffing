        ...
        <div className="grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:items-start">
          ...
          <Reveal delay={80}>
            <FAQ items={[
              ...
              { q: 'Can a search be confidential?', a: 'Yes. Many mandates are sensitive. We engage the market discreetly and protect both your organisation and candidate confidentiality throughout.' },

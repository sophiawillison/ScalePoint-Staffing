    ...
    <div>
                  ...
                  return (
                    <td key={c} className="px-1.5 py-1.5">
                      <div
                        ...
                        style={{
                          backgroundColor: `rgba(142,169,255,${0.10 + v * 0.72})`,
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 text-[12px] text-slate">
          <span>Lower</span>
          <span className="h-3 w-24 rounded" style={{ background: 'linear-gradient(90deg, rgba(142,169,255,0.12), rgba(142,169,255,0.82))' }} />
          <span>Higher</span>
        </div>
      </div>
    </div>

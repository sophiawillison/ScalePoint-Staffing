    ...
    <>
      ...
      <section className="relative overflow-hidden bg-carbon on-dark">
        ...
        <div className="shell relative flex min-h-[74vh] flex-col justify-center pb-24 pt-40">
          ...
          <Reveal delay={160}>
            <p className="mt-6 max-w-2xl text-[19px] leading-relaxed text-mineral/75">
      ...
      <Section className="bg-surface">
        <div className="grid items-stretch gap-6 md:grid-cols-2">
          <div className="flex h-full flex-col rounded-card-lg border border-mist bg-mineral p-8">
            ...
            <div className="mt-6"><ButtonLink href="/for-executives" variant="primary" arrow>Explore For Executives</ButtonLink></div>
          </div>
          <div className="flex h-full flex-col rounded-card-lg border border-plum/30 bg-mineral p-8">
            ...
            <div className="mt-6"><ButtonLink href="/for-employers" variant="primary" arrow>Explore For Employers</ButtonLink></div>
          </div>
        </div>
      </Section>
    </>
